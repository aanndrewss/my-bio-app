	...
	return (
		<section id='home' className='flex h-screen justify-center py-28 md:h-auto'>
			<div className='flex flex-col justify-center'>
				<div className='relative mb-32 flex flex-row gap-28 md:mb-10 md:flex-col-reverse md:justify-center md:items-center md:gap-4'>
					<motion.div
						viewport={{ once: true }}
						initial='hidden'
						whileInView='show'
					...
					>
						...
						<Paragraph className='mb-2 max-w-[320px] md:text-center'>
							Freelancer and student. I am developing user interfaces. Based in Kazan, Russia. 📍
						</Paragraph>
				...
				>
					...
					<ul className='flex flex-row flex-wrap justify-center gap-10 md:gap-6'>
						{tech.map((t: ITech) => (
							<li className='cursor-pointer text-4xl' style={{ color: `${t.color}` }} key={t.id}>
